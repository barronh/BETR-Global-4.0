...
chemnr = [1]*len(runID)  # selection of chemical from chemical properties files
...
for i in range(0, len(runID)):
    ...
    m.output_dyn(filename = 'OUT', units = ['mol', 'Pa', 'mol_per_m3', 'ng_per_m3'], netcdf = True, cpk = False)
